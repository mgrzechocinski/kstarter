...
class KotlinIdiomsTest {
    ...
    @Test fun `should lambda parameter be ommitable`() {
    ...
    @Test fun `should interpolate string`() {
        val x = "Matt"

        expect that "Hi, $x!" isEqualTo "Hi, Matt!"
    }

    @Test fun `should traverse map`() {
    ...
    @Test fun `should play with ranges`() {
    ...
    @Test fun `should collection be immutable`() {
    ...
    @Test fun `should use extension function`() {
    ...
    @Test fun `should play with null safety`() {
    ...
    @Test fun `should return when statemant`() {
    ...
    @Test fun `should use with keyword to call one object multiple time`() {
    ...
    @Ignore
    @Test fun `should run inline fun`() {
        TODO("Too late at night. Not implemented yet")
    }

    @Test fun `should consume nullable Boolean`() {
