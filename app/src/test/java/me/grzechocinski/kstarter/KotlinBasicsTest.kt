...
class KotlinBasicsTest {
    ...
    @Test fun `should check for nulls and do smart casting`() {
    ...
    @Test fun `should evaluate when expression`() {
    ...
    @Test fun `should iterate over range with steps`() {
        for (i in 0..10 step 2) {
            expect that i % 2 isEqualTo 0
        }
    }

    @Test fun `should make fun with streams`() {
